d3 = (function() {
  ...
  function q(n) {
    return (
      arguments.length || (n = ya.ascending),
      function(t, e) {
  ...
  function D(n, t, e) {
    ...
    function u() {
      var t,
        e = new RegExp('^__on([^.]+)' + ya.requote(n) + '$');
      for (var r in this)
        if ((t = r.match(e))) {
          var i = this[r];
  ...
  function J(n, t, e) {
    return (
      isNaN(n) && (n = 0),
      isNaN(t) && (t = 0),
      G(e, Math.cos((n *= to)) * t, Math.sin(n) * t)
    );
  }
  function G(n, t, e) {
    return new K(n, t, e);
  ...
  function Q(n, t, e) {
    ...
    return (
      ...
      (u = tt(u) * oo),
      at(
        rt(3.2404542 * i - 1.5371385 * r - 0.4985314 * u),
        rt(-0.969266 * i + 1.8760108 * r + 0.041556 * u),
        rt(0.0556434 * i - 0.2040259 * r + 1.0572252 * u)
      )
    );
  }
  function nt(n, t, e) {
    return n > 0
      ? $(Math.atan2(e, t) * eo, Math.sqrt(t * t + e * e), n)
      : $(0 / 0, 0 / 0, n);
  }
  function tt(n) {
  ...
  function ft(n, t, e) {
    ...
    var r = et((0.4124564 * n + 0.3575761 * t + 0.1804375 * e) / uo),
      i = et((0.2126729 * n + 0.7151522 * t + 0.072175 * e) / ao),
      u = et((0.0193339 * n + 0.119192 * t + 0.9503041 * e) / oo);
  ...
  function Mt() {
    var n = bt(),
      t = _t() - n;
    t > 24
      ? (isFinite(t) && (clearTimeout(po), (po = setTimeout(Mt, t))), (go = 0))
      : ((go = 1), vo(Mt));
  }
  function xt(n, t, e) {
  ...
  function bt() {
    var n = Date.now();
    for (mo = fo; mo; )
      n >= mo.time && (mo.flush = mo.callback(n - mo.time)), (mo = mo.next);
    return n;
  }
  function _t() {
    for (var n, t = fo, e = 1 / 0; t; )
      t.flush
        ? (t = n ? (n.next = t.next) : (fo = t.next))
  ...
  function Gt(n, t) {
    return (
      ((n = n.point)[0] < 0 ? n[1] - Ka / 2 - Qa : Ka / 2 - n[1]) -
      ((t = t.point)[0] < 0 ? t[1] - Ka / 2 - Qa : Ka / 2 - t[1])
    );
  }
  function Kt(n, t) {
    var e = n[0],
      ...
      if (h) {
        for (
          ...
          var M = n[0],
            ...
            E = d * b;
          if (
            (Co.add(Math.atan2(E * Math.sin(w), v * _ + E * Math.cos(w))),
            Math.abs(x) < Qa && (o = !0),
            (u += S ? w + (w >= 0 ? 2 : -2) * Ka : w),
            S ^ (p >= e) ^ (M >= e))
          ) {
    ...
    return {
      ...
      point: function(u, a) {
        ...
        Math.abs(c - Ka) < Qa
          ...
          : i !== o &&
            c >= Ka &&
            (Math.abs(e - i) < Qa && (e -= i * Qa),
            Math.abs(u - o) < Qa && (u -= o * Qa),
            (r = ne(e, r, u, a)),
            n.point(i, r),
            n.lineEnd(),
            n.lineStart(),
    ...
    function r(n, t, e) {
      ...
      if (!(0 > M)) {
        ...
        if (
          ...
          q
            ? N
              ? (E + k > 0) ^ (b[1] < (Math.abs(b[0] - w) < Qa ? E : k))
              : E <= b[1] && b[1] <= k
            : (A > Ka) ^ (w <= b[0] && b[0] <= S))
        ) {
          var T = Ht(d, (-v + x) / y);
  ...
  function ie(n, t, e, r) {
    ...
    function o(i, u) {
      var a = u[0] - i[0],
        o = u[1] - i[1],
        c = [0, 1];
      return Math.abs(a) < Qa && Math.abs(o) < Qa
      ...
      var y,
        ...
        T = {
          ...
          polygonEnd: function() {
            (c = N),
              (y = ya.merge(y)).length
                ? (c.polygonStart(), Zt(y, u, l, h, c), c.polygonEnd())
                : s([n, t]) &&
                  (c.polygonStart(),
                  c.lineStart(),
                  h(null, null, 1, c),
    ...
    function e(t, u, a, o, c, l, s, f, h, g, p, m, d, v) {
      ...
      if (x > 4 * r && d--) {
        ...
        ((z * z) / x > r ||
          ...
          i > o * g + c * p + l * m) &&
          (e(t, u, a, o, c, l, N, q, k, (b /= S), (_ /= S), w, d, v),
          v.point(N, q),
          e(N, q, k, b, _, w, s, f, h, g, p, m, d, v));
      }
    }
    var r = 0.5,
      i = Math.cos(30 * to),
  ...
  function be(n) {
    ...
    return (
      ...
      (t.clipAngle = function(n) {
        return arguments.length
          ? ((x = null == n ? ((_ = n), Xo) : re((_ = +n) * to)), i())
          : _;
      }),
      (t.clipExtent = function(n) {
        return arguments.length
          ? ((w = n),
            (b = null == n ? mt : ie(n[0][0], n[0][1], n[1][0], n[1][1])),
            i())
          : w;
      }),
      (t.scale = function(n) {
  ...
  function _e(n, t) {
    return {
      point: function(e, r) {
        (r = n(e * to, r * to)),
          (e = r[0]),
          t.point(e > Ka ? e - 2 * Ka : -Ka > e ? e + 2 * Ka : e, r[1]);
      },
      sphere: function() {
        t.sphere();
      },
  ...
  function Ne(n, t) {
    ...
    return function(i, u, a, o) {
      null != i
        ? ((i = qe(e, i)),
          (u = qe(e, u)),
          (a > 0 ? u > i : i > u) && (i += 2 * a * Ka))
        : ((i = n + 2 * a * Ka), (u = n));
      for (var c, l = a * t, s = i; a > 0 ? s > u : u > s; s -= l)
        o.point((c = Pt([e, -r * Math.cos(s), -r * Math.sin(s)]))[0], c[1]);
    };
  }
  function qe(n, t) {
    var e = zt(t);
    ...
    var i = Math.cos(t),
      ...
      p = h
        ? function(n) {
            ...
            return [
              Math.atan2(i, r) * eo,
              Math.atan2(a, Math.sqrt(r * r + i * i)) * eo
            ];
          }
        : function() {
            return [n * eo, t * eo];
  ...
  function Fe(n, t) {
    ...
    return u
      ? ((e.invert = function(n, t) {
          ...
          return [
            Math.atan2(n, e) / u,
            2 * Math.atan(Math.pow(a / r, 1 / u)) - Ka / 2
          ];
        }),
        e)
      : Oe;
  ...
  function Ue(n) {
    function t(t) {
      ...
      for (
        var c, l = [], s = [], f = -1, h = t.length, g = pt(e), p = pt(r);
        ++f < h;
    ...
    return (
      ...
      (t.interpolate = function(n) {
        return arguments.length
          ? ((a = 'function' == typeof n ? (u = n) : (u = sc.get(n) || Xe).key),
            t)
          : a;
      }),
  ...
  function Ge(n, t) {
    return n.length < 3
      ? Xe(n)
      : n[0] +
          Qe((n.push(n[0]), n), nr([n[n.length - 2]].concat(n, [n[1]]), t));
  }
  function Ke(n, t) {
  ...
  function tr(n) {
    ...
    for (n.push(n[e - 1]); ++t <= e; )
      (r = n[t]), a.shift(), a.push(r[0]), o.shift(), o.push(r[1]), ar(c, a, o);
  ...
  function er(n) {
    ...
    for (e.push(ur(gc, u) + ',' + ur(gc, a)), --r; ++r < i; )
      (t = n[r]), u.shift(), u.push(t[0]), a.shift(), a.push(t[1]), ar(e, u, a);
    return e.join('');
  }
  function rr(n) {
    for (var t, e, r = -1, i = n.length, u = i + 4, a = [], o = []; ++r < 4; )
      (e = n[r % i]), a.push(e[0]), o.push(e[1]);
    for (t = [ur(gc, a), ',', ur(gc, o)], --r; ++r < u; )
      (e = n[r % i]),
        a.shift(),
        a.push(e[0]),
        o.shift(),
  ...
  function cr(n) {
    for (
      ...
      r[t] = (a + (a = or((i = u), (u = n[t + 1])))) / 2;
    return (r[t] = a), r;
  }
  function lr(n) {
    for (var t, e, r, i, u = [], a = cr(n), o = -1, c = n.length - 1; ++o < c; )
      (t = or(n[o], n[o + 1])),
        Math.abs(t) < 1e-6
          ? (a[o] = a[o + 1] = 0)
          : ((e = a[o] / t),
      ...
      i = {
        ...
        intersect: function(n, t) {
          ...
          var u,
            ...
            l = e.region.r,
            s = r.region.r;
          l.y < s.y || (l.y == s.y && l.x < s.x)
            ? ((u = n), (a = e))
            : ((u = t), (a = r));
          var f = o >= a.region.r.x;
          return (f && 'l' === u.side) || (!f && 'r' === u.side)
            ? null
            : { x: o, y: c };
        },
    ...
    for (var a, o, c, l, s, f, h, g, p, m, d, v, y, M = e.list.shift(); ; )
      if (
        ...
        (o = r.leftBound(M)),
          ...
          r.insert(o, f),
          (m = i.intersect(o, f)),
          m && (u.del(o), u.insert(o, m, i.distance(m, M))),
          (o = f),
          (f = r.createHalfEdge(v, 'r')),
          r.insert(o, f),
          (m = i.intersect(f, c)),
          m && u.insert(f, m, i.distance(m, M)),
          (M = e.list.shift());
      else {
        if (u.empty()) break;
        (o = u.extractMin()),
          ...
          (g = r.rightRegion(c)),
          (d = o.vertex),
          i.endPoint(o.edge, o.side, d),
          i.endPoint(c.edge, c.side, d),
          r.del(o),
          u.del(c),
          r.del(c),
          (y = 'l'),
          ...
          i.endPoint(v, mc[y], d),
          (m = i.intersect(l, f)),
          m && (u.del(l), u.insert(l, m, i.distance(m, h))),
          (m = i.intersect(f, s)),
          m && u.insert(f, m, i.distance(m, h));
      }
  ...
  function Mr(n, t, e, r, i, u) {
    if (!n(t, e, r, i, u)) {
      var a = 0.5 * (e + i),
        o = 0.5 * (r + u),
        c = t.nodes;
      c[0] && Mr(n, c[0], e, r, a, o),
        c[1] && Mr(n, c[1], a, r, i, o),
        c[2] && Mr(n, c[2], e, o, a, u),
        c[3] && Mr(n, c[3], a, o, i, u);
    }
  }
  function xr(n, t) {
  ...
  function wr(n, t) {
    var e,
      ...
      l = [],
      s = [];
    for (n += '', t += '', dc.lastIndex = 0, r = 0; (e = dc.exec(t)); ++r)
      e.index && l.push(t.substring(o, (c = e.index))),
        s.push({ i: l.length, x: e[0] }),
        l.push(null),
        (o = dc.lastIndex);
    for (
      o < t.length && l.push(t.substring(o)), r = 0, u = s.length;
      (e = dc.exec(n)) && u > r;
      ++r
    )
      if (((a = s[r]), a.x == e[0])) {
  ...
  function Sr(n, t) {
    for (
      var e, r = ya.interpolators.length;
      --r >= 0 && !(e = ya.interpolators[r](n, t));
  ...
  function Ir(n) {
    ...
    t[0] * e[1] < e[0] * t[1] &&
      ((t[0] *= -1), (t[1] *= -1), (r *= -1), (i *= -1)),
      (this.rotate =
        (r ? Math.atan2(t[1], t[0]) : Math.atan2(-e[0], e[1])) * eo),
      (this.translate = [n.e, n.f]),
      (this.scale = [r, u]),
      (this.skew = u ? Math.atan2(i, u) * eo : 0);
  }
  function Vr(n, t) {
    ...
    return (
      o[0] != c[0] || o[1] != c[1]
        ? (r.push('translate(', null, ',', null, ')'),
          i.push({ i: 1, x: _r(o[0], c[0]) }, { i: 3, x: _r(o[1], c[1]) }))
        : c[0] || c[1]
        ? r.push('translate(' + c + ')')
        : r.push(''),
      l != s
      ...
      f != h
        ? i.push({ i: r.push(r.pop() + 'skewX(', null, ')') - 2, x: _r(f, h) })
  ...
  function Kr(n, t) {
    if (n === t) return n;
    for (
      var e = Gr(n), r = Gr(t), i = e.pop(), u = r.pop(), a = null;
      i === u;
  ...
  function ii(n, t) {
    return (
      ya.rebind(n, t, 'sort', 'children', 'value'),
      (n.nodes = n),
      (n.links = ci),
      n
    );
      ...
      if (
        ...
        for (
          ...
          if (1 == p)
            for (
              c = r._pack_prev;
              c !== o._pack_prev && !ji(c, u);
              c = c._pack_prev, d++
            );
          p
            ? (d > m || (m == d && i.r < r.r) ? Di(r, (i = o)) : Di((r = c), i),
              a--)
            : (zi(r, u), (i = u), t(u));
        }
      var v = (s + f) / 2,
  ...
  function iu(n, t, e) {
    var r = -Math.floor(Math.log(eu(n, t)[2]) / Math.LN10 + 0.01);
    return ya.format(
      e
        ? e.replace(wo, function(n, t, e, i, u, a, o, c, l, s) {
            return [
              t,
              e,
              i,
  ...
  function uu(n, t, e, r) {
    ...
    return (
      ...
      (a.domain = function(t) {
        return arguments.length
          ? ((e = t[0] >= 0), n.domain((r = t.map(Number)).map(i)), a)
          : r;
      }),
      (a.base = function(e) {
      ...
      (a.ticks = function() {
        ...
        if (isFinite(s - l)) {
          if (e) {
            for (; s > l; l++) for (var h = 1; f > h; h++) a.push(u(l) * h);
            a.push(u(l));
          } else
            for (a.push(u(l)); l++ < s; )
      ...
      (a.tickFormat = function(n, t) {
        ...
        arguments.length < 2
          ? (t = Ac)
          : 'function' != typeof t && (t = ya.format(t));
        var r,
          o = Math.max(0.1, n / a.ticks().length),
  ...
  function au(n, t, e) {
    ...
    return (
      ...
      (r.exponent = function(a) {
        return arguments.length
          ? ((i = ou((t = a))), (u = ou(1 / t)), n.domain(e.map(i)), r)
          : t;
      }),
      (r.copy = function() {
  ...
  function cu(n, t) {
    ...
    return (
      ...
      (e.rangePoints = function(i, u) {
        ...
        return (
          (a = r(n.length < 2 ? (c + l) / 2 : c + (s * u) / 2, s)),
          (o = 0),
    ...
    return (
      ...
      (r.invertExtent = function(e) {
        return (
          ...
          0 > e
            ? [0 / 0, 0 / 0]
            : [e > 0 ? i[e - 1] : n[0], e < i.length ? i[e] : n[n.length - 1]]
        );
      }),
      (r.copy = function() {
        return lu(n, t);
  ...
  function yu(n) {
    ...
    return (
      ...
      (t.interpolate = function(n) {
        return arguments.length
          ? ((c = 'function' == typeof n ? (o = n) : (o = sc.get(n) || Xe).key),
            (l = o.reverse || o),
            (s = o.closed ? 'M' : 'L'),
            t)
          : c;
          ...
          function(r) {
            function i(r) {
              return u.active > e
                ? l()
                : ((u.active = e),
                  a.event && a.event.start.call(n, s, t),
            ...
            function c(r) {
              ...
              for (var i = (r - h) / g, o = f(i), c = p.length; c > 0; )
                p[--c].call(n, o);
              return i >= 1
                ? (l(), a.event && a.event.end.call(n, s, t), 1)
                : void 0;
            }
            function l() {
  ...
  (ya.ascending = function(n, t) {
    ...
    (ya.median = function(t, e) {
      return (
        ...
        (t = t.filter(n)),
        t.length ? ya.quantile(t.sort(ya.ascending), 0.5) : void 0
      );
    }),
  ...
  (ya.bisectLeft = Na.left),
    (ya.bisect = ya.bisectRight = Na.right),
    (ya.shuffle = function(n) {
    ...
    r(i, {
      ...
      forEach: function(n) {
        for (var t in this)
          t.charCodeAt(0) === Ta && n.call(this, t.substring(1), this[t]);
      }
    });
  var qa = '\0',
    Ta = qa.charCodeAt(0);
  (ya.nest = function() {
    function n(t, o, c) {
      ...
      for (
        var l, s, f, h, g = -1, p = o.length, m = a[c++], d = new i();
        ++g < p;

      )
        (h = d.get((l = m((s = o[g]))))) ? h.push(s) : d.set(l, [s]);
      return (
        t
          ? ((s = t()),
            (f = function(e, r) {
    ...
    r(u, {
      ...
      forEach: function(n) {
        for (var t in this)
          t.charCodeAt(0) === Ta && n.call(this, t.substring(1));
      }
    }),
    (ya.behavior = {}),
    (ya.rebind = function(n, t) {
  ...
  (Ya.select = function(n) {
    ...
    for (var a = -1, o = this.length; ++a < o; ) {
      ...
      for (var c = -1, l = r.length; ++c < l; )
        (i = r[c])
          ? (t.push((e = n.call(i, i.__data__, c, a))),
    ...
    (Ya.selectAll = function(n) {
      ...
      for (var i = -1, u = this.length; ++i < u; )
        for (var a = this[i], o = -1, c = a.length; ++o < c; )
          (e = a[o]) &&
            (r.push((t = za(n.call(e, e.__data__, o, i)))), (t.parentNode = e));
      return d(r);
    });
  var Ra = {
  ...
  (ya.ns = {
    ...
    qualify: function(n) {
      ...
      return (
        ...
        Ra.hasOwnProperty(e) ? { space: Ra[e], local: n } : n
      );
    }
  }),
    ...
    (Ya.style = function(n, t, e) {
      ...
      if (3 > r) {
        ...
        if (2 > r)
          return ba.getComputedStyle(this.node(), null).getPropertyValue(n);
        e = '';
      }
      ...
      function e(n, e) {
        ...
        if (t) {
          ...
          for (r = -1; ++r < h; )
            (u = n[r]),
              (a = e[r]),
              u ? ((u.__data__ = a), (g[r] = u)) : (p[r] = A(a));
          for (; f > r; ++r) p[r] = A(e[r]);
          for (; o > r; ++r) m[r] = n[r];
        }
        (p.update = g),
          (p.parentNode = g.parentNode = m.parentNode = n.parentNode),
          c.push(p),
          l.push(g),
          s.push(m);
      }
  ...
  var Ua = [];
  (ya.selection.enter = C),
    (ya.selection.enter.prototype = Ua),
    (Ua.append = Ya.append),
    (Ua.empty = Ya.empty),
    (Ua.node = Ya.node),
    (Ua.call = Ya.call),
    ...
    (Ua.select = function(n) {
      for (var t, e, r, i, u, a = [], o = -1, c = this.length; ++o < c; ) {
        ...
        for (var l = -1, s = i.length; ++l < s; )
          (u = i[l])
            ? (t.push((r[l] = e = n.call(i.parentNode, u.__data__, l, o))),
    ...
    (Ya.transition = function() {
      for (
        var n,
          ...
          e = Hc || ++Rc,
          r = [],
          i = Fc || { time: Date.now(), ease: Cr, delay: 0, duration: 250 },
          u = -1,
          a = this.length;
        ++u < a;
  ...
  var Va = ya.map({ mouseenter: 'mouseover', mouseleave: 'mouseout' });
  ...
  (ya.touches = function(n, t) {
    ...
    (ya.behavior.drag = function() {
      ...
      function r(n, t, e, r) {
        return function() {
          ...
          function o() {
            v.on(e + '.' + p, null).on(r + '.' + p, null),
              y(d && ya.event.target === h),
              f({ type: 'dragend' });
          }
          var c,
            l = this,
            ...
            y = H();
          u
            ? ((c = u.apply(l, arguments)), (c = [c.x - m[0], c.y - m[1]]))
            : (c = [0, 0]),
            f({ type: 'dragstart' });
        };
      }
    ...
    (ya.behavior.zoom = function() {
      ...
      function a(n) {
        u(), n({ type: 'zoom', scale: b, translate: x });
      }
      function o() {
        function n() {
        ...
        function e() {
          l.on(S, ba === r ? s : null).on(E, null),
            h(c && ya.event.target === o);
        }
        var r = this,
          u = q.of(r, arguments),
          o = ya.event.target,
      ...
      function c() {
        ...
        function l() {
          ya.event.touches.length
            ? n()
            : (v.on(A, null).on(N, null), y.on(w, o).on(k, c), M());
        }
        var s,
          f,
          h = this,
      ...
      function l() {
        g(),
          h || (h = t(ya.mouse(this))),
          r(Math.pow(2, 0.002 * $a()) * b),
          i(ya.mouse(this), h),
          a(q.of(this, arguments));
      }
      function s() {
        h = null;
      }
      function f() {
        ...
        r(
          Math.pow(2, ya.event.shiftKey ? Math.ceil(u) - 1 : Math.floor(u) + 1)
        ),
          i(n, e),
          a(q.of(this, arguments));
      }
      ...
      return (
        ...
        (n.scaleExtent = function(t) {
          return arguments.length
            ? ((_ = null == t ? Wa : t.map(Number)), n)
            : _;
        }),
        (n.x = function(t) {
          return arguments.length
            ? ((v = t), (d = t.copy()), (x = [0, 0]), (b = 1), n)
            : v;
        }),
        (n.y = function(t) {
          return arguments.length
            ? ((M = t), (y = t.copy()), (x = [0, 0]), (b = 1), n)
            : M;
        }),
        ya.rebind(n, q, 'on')
      );
  ...
  (Ga.brighter = function(n) {
    return (
      ...
      O(this.h, this.s, this.l / n)
    );
  }),
    (Ga.darker = function(n) {
      return (
        (n = Math.pow(0.7, arguments.length ? n : 1)),
        O(this.h, this.s, n * this.l)
      );
    }),
    (Ga.rgb = function() {
  ...
  ya.hcl = function(n, t, e) {
    return 1 === arguments.length
      ? n instanceof W
        ...
        : n instanceof K
        ? nt(n.l, n.a, n.b)
        : nt((n = ft((n = ya.rgb(n)).r, n.g, n.b)).l, n.a, n.b)
      : $(+n, +t, +e);
  };
  ...
  so.forEach(function(n, t) {
    ...
    (ya.dsv = function(n, t) {
      ...
      return (
        ...
        (e.parseRows = function(n, t) {
          ...
          for (
            var r, i, u = {}, a = {}, o = [], c = n.length, s = 0, f = 0;
            (r = e()) !== a;
    ...
    (ya.csv = ya.dsv(',', 'text/csv')),
    (ya.tsv = ya.dsv('	', 'text/tab-separated-values'));
  var fo,
    ho,
    go,
    po,
  ...
  (ya.timer = function(n, t, e) {
    ...
    var i = e + t,
      u = { callback: n, time: i, next: null };
    ho ? (ho.next = u) : (fo = u),
      (ho = u),
      go || ((po = clearTimeout(po)), (go = 1), vo(Mt));
  }),
      ...
      '#' === u ? (u = '') : '$' === u && (u = bo),
        ...
        null != l &&
          ('g' == s
            ...
            : ('e' == s || 'f' == s) && (l = Math.max(0, Math.min(20, l)))),
        (s = So.get(s) || Et);
      var p = a && c;
      return function(n) {
        if (g && n % 1) return '';
        ...
        return (
          ...
          ('<' === r
            ...
            ? x + t + n
            : '^' === r
            ? x.substring(0, (M >>= 1)) + t + n + x.substring(M)
            : t + (p ? n : x + n)) + h
        );
      };
    });
  var wo = /(?:([^{])?([<>=^]))?([+\- ])?([$#])?(0)?(\d+)?(,)?(\.-?\d+)?([a-z%])?/i,
    So = ya.map({
      ...
      r: function(n, t) {
        return (n = ya.round(n, St(n, t))).toFixed(
  ...
  if (xo) {
    var ko = xo.length;
    Eo = function(n) {
      for (var t = n.length, e = [], r = 0, i = xo[0]; t > 0 && i > 0; )
        e.push(n.substring((t -= i), t + i)), (i = xo[(r = (r + 1) % ko)]);
  ...
  (ya.geo = {}),
    (kt.prototype = {
      ...
      add: function(n) {
        At(n, this.t, Ao),
          At(Ao.s, this.s, this),
          this.s ? (this.t += Ao.t) : (this.s = Ao.t);
      },
      reset: function() {
        this.s = this.t = 0;
      },
  ...
  var To,
    ...
    zo = {
      ...
      polygonEnd: function() {
        var n = 2 * Co;
        (To += 0 > n ? 4 * Ka + n : n),
          (zo.lineStart = zo.lineEnd = zo.point = s);
      }
    };
  (ya.geo.bounds = (function() {
    ...
    (ya.geo.centroid = function(n) {
      (Do = jo = Lo = Ho = Fo = Po = Oo = Yo = Ro = Uo = Io = 0),
        ya.geo.stream(n, Vo);
      var t = Ro,
        e = Uo,
        r = Io,
      ...
      return no > i &&
        ...
        (e = Oo),
        (r = Yo),
        Qa > jo && ((t = Lo), (e = Ho), (r = Fo)),
        (i = t * t + e * e + r * r),
        no > i)
        ? [0 / 0, 0 / 0]
        : [Math.atan2(e, t) * eo, V(r / Math.sqrt(i)) * eo];
    });
  var Do,
    jo,
    Lo,
        ...
        (n.translate = function(t) {
          ...
          return (
            ...
            (r = a
              ...
              .clipExtent([
                [s - 0.425 * l + Qa, f + 0.12 * l + Qa],
                [s - 0.214 * l - Qa, f + 0.234 * l - Qa]
              ])
              .stream(c).point),
            (i = o
              .translate([s - 0.205 * l, f + 0.212 * l])
              .clipExtent([
                [s - 0.214 * l + Qa, f + 0.166 * l + Qa],
                [s - 0.115 * l - Qa, f + 0.234 * l - Qa]
              ])
              .stream(c).point),
            n
          );
  ...
  (ya.geo.path = function() {
    ...
    return (
      ...
      (n.centroid = function(n) {
        return (
          (Lo = Ho = Fo = Po = Oo = Yo = Ro = Uo = Io = 0),
          ya.geo.stream(n, i(ec)),
          Io
            ? [Ro / Io, Uo / Io]
            : Yo
            ? [Po / Yo, Oo / Yo]
      ...
      (n.bounds = function(n) {
        return (
          (Ko = Qo = -(Jo = Go = 1 / 0)),
          ya.geo.stream(n, i(tc)),
          [[Jo, Go], [Ko, Qo]]
        );
      }),
      (n.projection = function(n) {
        return arguments.length
          ? ((i = (e = n) ? n.stream || Me(n) : mt), t())
          : e;
      }),
      (n.context = function(n) {
        return arguments.length
          ? ((u = null == (r = n) ? new fe() : new ve(n)),
    ...
    (ya.geo.projection = xe),
    (ya.geo.projectionMutator = be),
    ((ya.geo.equirectangular = function() {
      return xe(we);
    }).raw = we.invert = we),
    (ya.geo.rotation = function(n) {
      function t(t) {
        return (t = n(t[0] * to, t[1] * to)), (t[0] *= eo), (t[1] *= eo), t;
      }
      return (
        (n = Se((n[0] % 360) * to, n[1] * to, n.length > 2 ? n[2] * to : 0)),
        (t.invert = function(t) {
          return (
            (t = n.invert(t[0] * to, t[1] * to)), (t[0] *= eo), (t[1] *= eo), t
          );
        }),
        t
      );
    ...
    (ya.geo.distance = function(n, t) {
      var e,
        ...
        f = Math.cos(u);
      return Math.atan2(
        Math.sqrt((e = f * a) * e + (e = l * s - c * f * o) * e),
        c * s + l * f * o
      );
    }),
    (ya.geo.graticule = function() {
      ...
      function t() {
        return ya
          ...
          .map(h)
          .concat(ya.range(Math.ceil(l / v) * v, c, v).map(g))
          .concat(
            ya
      ...
      return (
        ...
        n
          .majorExtent([[-180, -90 + Qa], [180, 90 - Qa]])
          .minorExtent([[-180, -80 - Qa], [180, 80 + Qa]])
      );
    }),
  ...
  ((ya.geo.azimuthalEquidistant = function() {
    ...
    ((ya.geo.conicConformal = function() {
      return oe(Fe);
    }).raw = Fe),
    ((ya.geo.conicEquidistant = function() {
      return oe(Pe);
    }).raw = Pe);
  ...
  (ya.geom.hull = function(n) {
    function t(n) {
      ...
      if (m === Ie && r === Ve) t = n;
        ...
        for (u = 0, t = []; v > u; ++u)
          t.push([+m.call(this, (i = n[u]), u), +d.call(this, i, u)]);
      for (u = 1; v > u; ++u)
    ...
    (pc.clip = function(n) {
      for (
        ...
        for (
          ...
          (a = t[e]),
            hr(a, s, i)
              ? (hr(u, s, i) || n.push(gr(u, a, s, i)), n.push(a))
              : hr(u, s, i) && n.push(gr(u, a, s, i)),
            (u = a);
        o && n.push(n[0]), (s = i);
      }
      return n;
  ...
  (ya.geom.quadtree = function(n, t, e, r, i) {
        ...
        if (!isNaN(e) && !isNaN(r))
          if (n.leaf) {
            var c = n.x,
              s = n.y;
            if (null != c)
              if (Math.abs(c - e) + Math.abs(s - r) < 0.01)
                l(n, t, e, r, i, u, a, o);
              else {
                var f = n.point;
    ...
    return (a = arguments.length)
      ? ((o = dr), (c = vr), 3 === a && ((i = e), (r = t), (e = t = 0)), u(n))
      : ((u.x = function(n) {
    ...
    (ya.interpolateRgb = xr),
    (ya.interpolateObject = br),
    (ya.interpolateNumber = _r),
    (ya.interpolateString = wr);
  var dc = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g;
  (ya.interpolate = Sr),
    (ya.interpolators = [
      function(n, t) {
  ...
  (ya.ease = function(n) {
    ...
    (ya.interpolateHcl = Or),
    (ya.interpolateHsl = Yr),
    (ya.interpolateLab = Rr),
    (ya.interpolateRound = Ur),
    (ya.transform = function(n) {
  ...
  var xc = { a: 1, b: 0, c: 0, d: 1, e: 0, f: 0 };
  (ya.interpolateTransform = Br),
    (ya.layout = {}),
    (ya.layout.bundle = function() {
      return function(n) {
    ...
    (ya.layout.force = function() {
      ...
      return (
        (o.tick = function() {
          ...
          for (e = 0; _ > e; ++e)
            (o = v[e]),
              ...
              (x = h.y - f.y),
              (m = M * M + x * x) &&
                ((m = (r * u[e] * ((m = Math.sqrt(m)) - i[e])) / m),
                (M *= m),
                (x *= m),
                (h.x -= M * (y = f.weight / (h.weight + f.weight))),
                (h.y -= x * y),
                (f.x += M * (y = 1 - y)),
                (f.y += x * y));
          if ((y = r * p) && ((M = l[0] / 2), (x = l[1] / 2), (e = -1), y))
            for (; ++e < b; )
              (o = d[e]), (o.x += (M - o.x) * y), (o.y += (x - o.y) * y);
          if (g)
            for (ri((t = ya.geom.quadtree(d)), r, a), e = -1; ++e < b; )
              (o = d[e]).fixed || t.visit(n(o));
          for (e = -1; ++e < b; )
            (o = d[e]),
              o.fixed
                ? ((o.x = o.px), (o.y = o.py))
        ...
        (o.start = function() {
          ...
          for (e = 0; m > e; ++e)
            (s = v[e]),
              'number' == typeof s.source && (s.source = d[s.source]),
              'number' == typeof s.target && (s.target = d[s.target]),
              ++s.source.weight,
              ++s.target.weight;
          for (e = 0; p > e; ++e)
            (s = d[e]),
  ...
  (ya.layout.hierarchy = function() {
    function n(t, a, o) {
      ...
      if (((t.depth = a), o.push(t), c && (l = c.length))) {
        for (
          var l, s, f = -1, h = (t.children = []), g = 0, p = a + 1;
          ++f < l;
  ...
  ya.layout.stack = function() {
    function n(o, c) {
      ...
      var h,
        ...
        v = l[0].length;
      for (g = 0; v > g; ++g)
        for (i.call(n, l[0][g], (p = m[g]), s[0][g][1]), h = 1; d > h; ++h)
    ...
    return (
      ...
      (n.order = function(t) {
        return arguments.length
          ? ((e = 'function' == typeof t ? t : Sc.get(t) || hi), n)
          : e;
      }),
      (n.offset = function(t) {
        return arguments.length
          ? ((r = 'function' == typeof t ? t : Ec.get(t) || gi), n)
          : r;
      }),
      (n.x = function(t) {
        return arguments.length ? ((u = t), n) : u;
  ...
  var Sc = ya.map({
      'inside-out': function(n) {
        ...
        for (t = 0; r > t; ++t)
          (e = a[t]),
            c > o ? ((o += u[e]), l.push(e)) : ((c += u[e]), s.push(e));
      ...
      if (g > 0)
        for (u = -1; ++u < h; )
          (o = l[u]),
            o >= s[0] &&
              o <= s[1] &&
              ((a = c[ya.bisect(f, o, 1, g) - 1]), (a.y += p), a.push(n[u]));
      return c;
    }
    var t = !0,
      e = Number,
          ...
          if (t) {
            for (
              ...
              (c = bi(c)),
                (a = _i(a)),
                (a._tree.ancestor = n),
                (i = o._tree.prelim + f - u._tree.prelim - l + e(o, u)),
                i > 0 && (qi(Ti(o, n, r), n, i), (l += i), (s += i)),
                (f += o._tree.mod),
                (l += u._tree.mod),
                (h += c._tree.mod),
                (s += a._tree.mod);
            o && !_i(a) && ((a._tree.thread = o), (a._tree.mod += f - s)),
              u &&
                !bi(c) &&
      ...
      function t(e) {
        ...
        if (u && u.length) {
          ...
          for (n(h, (l.dx * l.dy) / e.value), s.area = 0; (c = h.length) > 0; )
            s.push((a = h[c - 1])),
              (s.area += a.area),
              'squarify' !== g || (o = r(s, m)) <= p
                ? (h.pop(), (p = o))
                : ((s.area -= s.pop().area),
                  i(s, m, l, !1),
                  (m = Math.min(l.dx, l.dy)),
                  (s.length = s.area = 0),
                  (p = 1 / 0));
        ...
        if (t == e.dx) {
          for ((r || s > e.dy) && (s = e.dy); ++u < a; )
            (i = n[u]),
              ...
              (i.y = l),
              (i.dy = s),
              (o += i.dx = Math.min(e.x + e.dx - o, s ? c(i.area / s) : 0));
          ...
          for ((r || s > e.dx) && (s = e.dx); ++u < a; )
            (i = n[u]),
              ...
              (i.y = l),
              (i.dx = s),
              (l += i.dy = Math.min(e.y + e.dy - l, s ? c(i.area / s) : 0));
      ...
      return (
        ...
        (u.padding = function(n) {
          function t(t) {
            ...
            return null == e
              ? Vi(t)
              : Xi(t, 'number' == typeof e ? [e, e, e, e] : e);
          }
          function e(t) {
            return Xi(t, n);
          }
  ...
  (ya.scale.pow = function() {
    ...
    (ya.scale.sqrt = function() {
      return ya.scale.pow().exponent(0.5);
    }),
  ...
  (Yc.call = Ya.call),
    ...
    (Yc.node = Ya.node),
    (Yc.size = Ya.size),
    (ya.transition = function(n) {
      return arguments.length ? (Hc ? n.transition() : n) : Ia.transition();
    }),
    (ya.transition.prototype = Yc),
    (Yc.select = function(n) {
      var t,
        e,
        r,
        i = this.id,
      ...
      for (var a = -1, o = this.length; ++a < o; ) {
        u.push((t = []));
        for (var c = this[a], l = -1, s = c.length; ++l < s; )
          (r = c[l]) && (e = n.call(r, r.__data__, l, a))
            ? ('__data__' in r && (e.__data__ = r.__data__),
              Nu(e, l, i, r.__transition__[i]),
              t.push(e))
            : t.push(null);
      }
      return Eu(u, i);
      ...
      function i(t) {
        return null == t
          ...
          : ((t += ''),
            function() {
              var r,
                i = ba.getComputedStyle(this, null).getPropertyValue(n);
              return (
                i !== t &&
                ((r = Sr(i, t)),
                function(t) {
    ...
    (Yc.styleTween = function(n, t, e) {
      function r(r, i) {
        var u = t.call(
          ...
          r,
          i,
          ba.getComputedStyle(this, null).getPropertyValue(n)
        );
        return (
          u &&
          function(t) {
    ...
    (Yc.ease = function(n) {
      ...
      return arguments.length < 1
        ...
        : ('function' != typeof n && (n = ya.ease.apply(ya, arguments)),
          T(this, function(e) {
    ...
    (Yc.transition = function() {
      for (
        var n, t, e, r, i = this.id, u = ++Rc, a = [], o = 0, c = this.length;
        c > o;
        o++
      ) {
        a.push((n = []));
        for (var t = this[o], l = 0, s = t.length; s > l; l++)
          (e = t[l]) &&
  ...
  var Uc = 'bottom',
    Ic = { top: 1, right: 1, bottom: 1, left: 1 };
  ya.svg.brush = function() {
    function n(u) {
      u.each(function() {
        ...
        a
          ...
          h.exit().remove(),
          o &&
            ((u = Bi(o)), s.attr('x', u[0]).attr('width', u[1] - u[0]), e(a)),
          c &&
            ((u = Bi(c)), s.attr('y', u[0]).attr('height', u[1] - u[0]), r(a)),
          t(a);
      });
    }
    function t(n) {
    ...
    function i() {
      ...
      function l() {
        32 == ya.event.keyCode &&
          (k || ((v = null), (N[0] -= s[1][0]), (N[1] -= s[1][1]), (k = 2)),
          g());
      }
      function h() {
        32 == ya.event.keyCode &&
          2 == k &&
          ((N[0] += s[1][0]), (N[1] += s[1][1]), (k = 0), g());
      }
      function p() {
        var n = i(),
          u = !1;
        y && ((n[0] += y[0]), (n[1] += y[1])),
          k ||
            (ya.event.altKey
              ? (v || (v = [(s[0][0] + s[1][0]) / 2, (s[0][1] + s[1][1]) / 2]),
                (N[0] = s[+(n[0] < v[0])][0]),
                (N[1] = s[+(n[1] < v[1])][1]))
              : (v = null)),
          S && m(n, o, 0) && (e(_), (u = !0)),
      ...
      function m(n, t, e) {
        ...
        return (
          k && ((o -= l), (c -= h + l)),
          (r = f[e] ? Math.max(o, Math.min(c, n[e])) : n[e]),
          k
            ? (i = (r += l) + h)
            : (v && (l = Math.max(o, Math.min(c, 2 * v[e] - r))),
              r > l ? ((i = r), (r = l)) : (i = l)),
          s[0][e] !== r || s[1][e] !== i
            ? ((u = null), (s[0][e] = r), (s[1][e] = i), !0)
            : void 0
        );
      }
      function d() {
        p(),
          ...
          ya.select('body').style('cursor', null),
          q
      ...
      var v,
        ...
        q = ya
          ...
          .on('keyup.brush', h);
      if (
        (ya.event.changedTouches
          ? q.on('touchmove.brush', p).on('touchend.brush', d)
          : q.on('mousemove.brush', p).on('mouseup.brush', d),
        k)
      )
      ...
      _.style('pointer-events', 'none')
        .selectAll('.resize')
        .style('display', null),
        ya.select('body').style('cursor', x.style('cursor')),
        b({ type: 'brushstart' }),
        p();
    }
    var u,
  ...
  (ya.time.year = Du(
    ...
    (ya.time.years = ya.time.year.range),
    (ya.time.years.utc = ya.time.year.utc.range),
    (ya.time.day = Du(
      function(n) {
        var t = new Zc(2e3, 0);
    ...
    (ya.time.days = ya.time.day.range),
    (ya.time.days.utc = ya.time.day.utc.range),
    (ya.time.dayOfYear = function(n) {
    ...
    Bc.forEach(function(n, t) {
      ...
      var e = (ya.time[n] = Du(
        function(n) {
          return (
            (n = ya.time.day(n)).setDate(n.getDate() - ((n.getDay() + t) % 7)),
            n
          );
        },
        function(n, t) {
        ...
        function(n) {
          ...
          return (
            Math.floor((ya.time.dayOfYear(n) + ((e + t) % 7)) / 7) - (e !== t)
          );
        }
      ));
      (ya.time[n + 's'] = e.range),
        (ya.time[n + 's'].utc = e.utc.range),
        (ya.time[n + 'OfYear'] = function(n) {
          var e = ya.time.year(n).getDay();
          return Math.floor((ya.time.dayOfYear(n) + ((e + t) % 7)) / 7);
        });
    }),
    (ya.time.week = ya.time.sunday),
    (ya.time.weeks = ya.time.sunday.range),
    (ya.time.weeks.utc = ya.time.sunday.utc.range),
    (ya.time.weekOfYear = ya.time.sundayOfYear),
    (ya.time.format = function(n) {
      function t(t) {
        for (var r, i, u, a = [], o = -1, c = 0; ++o < e; )
          37 === n.charCodeAt(o) &&
            (a.push(n.substring(c, o)),
            null != (i = fl[(r = n.charAt(++o))]) && (r = n.charAt(++o)),
            (u = hl[r]) && (r = u(t, null == i ? ('e' === r ? ' ' : '0') : i)),
            a.push(r),
            (c = o + 1));
  ...
  (ya.time.format.iso =
    ...
    (ya.time.seconds = ya.time.second.range),
    (ya.time.seconds.utc = ya.time.second.utc.range),
    (ya.time.minute = Du(
      function(n) {
    ...
    (ya.time.minutes = ya.time.minute.range),
    (ya.time.minutes.utc = ya.time.minute.utc.range),
    (ya.time.hour = Du(
      function(n) {
    ...
    (ya.time.hours = ya.time.hour.range),
    (ya.time.hours.utc = ya.time.hour.utc.range),
    (ya.time.month = Du(
      function(n) {
    ...
    (ya.time.months = ya.time.month.range),
    (ya.time.months.utc = ya.time.month.utc.range);
  var vl = [
      1e3,
      5e3,
      15e3,
